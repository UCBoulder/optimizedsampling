...
def get_sampling_directories(dataset, label=None):
    ...
    if dataset == "usavars":
        ...
        return {
            ...
            'random_sampling_dir': f"../../0_data/initial_samples/usavars/{label}/random_sampling",
            'results_dir': f"../../0_results/usavars/{label}",
            'dataset': dataset
        }
    
    elif dataset == "togo":
        return {
            'features_path': "../../0_data/features/togo/togo_fertility_data_all_2022_Jul_Dec_P20.pkl",
            'cluster_sampling_dir': "../../0_data/initial_samples/togo/cluster_sampling/fixedstrata_plateaux",
        ...
        return {
            ...
            'cluster_sampling_dir': "../../0_data/initial_samples/india_secc/cluster_sampling/randomstrata",
            ...
            'random_sampling_dir': "../../0_data/initial_samples/india_secc/random_sampling",
            'results_dir': "../../0_results/india_secc",
            'dataset': dataset
        }
