...
from models.swin import SwinV2Model
...
def main(cfg, train_data):
    ...
    if len(lSet) > 0:
        ...
        if r2 is not None:
            ...
            if X_train.shape[0] < 5:
                ...
                r2 = model.evaluate(X_test, y_test, logger=logger)
    ...
    if lSet_updated.size >= 5:
        logger.info("Training model on updated labeled set...")
        ...
        model.evaluate(X_test, y_test, logger=logger)
