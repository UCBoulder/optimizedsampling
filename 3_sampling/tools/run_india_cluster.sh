...
run_setting3() {
    ...
    for SIZE in 2000 3000 4000 5000; do
        for PPC in 20; do
            ...
            INIT_SET_IDS="/home/libe2152/optimizedsampling/0_data/initial_samples/india_secc/cluster_sampling/fixedstrata_01-04-06-08-09-11-21-23-25-33/sample_state_district_${PPC}ppc_${SIZE}_size_seed_1.pkl"
