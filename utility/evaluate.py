...
def load_data_for_label(label, group_type='nlcd'):
    ...
    # Load groups info
    if group_type == 'nlcd':
        group_path = f"../../0_data/groups/usavars/{label}/NLCD_cluster_assignments_8_dict.pkl"
    elif group_type == 'image_clusters_8':
        group_path = f"../../0_data/groups/usavars/{label}/image_8_cluster_assignments.pkl"
    elif group_type == 'image_clusters_2':
        group_path = f"../../0_data/groups/usavars/{label}/image_2_cluster_assignments.pkl"
    elif group_type == 'states':
        group_path = f"../../0_data/groups/usavars/{label}/state_assignments_dict.pkl"
    else:
    ...
    similarity_path = f"../../0_data/cosine_similarity/usavars/{label}/cosine_similarity_train_test.npy"
    print(f"Loading similarity matrix from: {similarity_path}")
    similarity_matrix = np.load(similarity_path)
    print(f"Similarity matrix shape: {similarity_matrix.shape}")
    
    similarity_train_path = f"../../0_data/cosine_similarity/usavars/{label}/cosine_similarity_train_train.npy"
...
def main():
    ...
    for label in labels:
        ...
        base_dir = f"../../0_data/initial_samples/usavars/{label}"
        ...
        if all_combined_results:
            output_path = f"../../0_results/usavars/{label}/utilities.csv"
