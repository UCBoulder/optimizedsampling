    ...
    * https://doi.org/10.1609/aaai.v31i1.11172
    ...
    def __init__(
        ...
        for country in self.countries:
            ...
            loc_file_path = image_file_path.replace('_hists', '_locs')
            ...
            loc_npz_file = np.load(loc_file_path, allow_pickle=True)['data']
            ...
            for idx in range(num_data_points):
                ...
                features = {
                    ...
                    'loc': torch.from_numpy(loc).to(dtype=torch.float32)
                }
